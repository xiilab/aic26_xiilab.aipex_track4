"""SigLIP2-L/16-512 + DoRA + PI(64->128), FILIP late interaction, full split, single GPU.

Same recipe and hyperparameters as anchor_filip_heldout, without the held-out exclusion.
