"""SigLIP2-L/16-512 + DoRA + PI(64->128), FILIP late interaction, held-out excluded, single GPU.
...
FINEGRAIN_ENABLED     = True  # FILIP token<->patch late interaction on (mutually exclusive with FLAIR)
...
def main():
    parser = argparse.ArgumentParser(
        description="SigLIP2-L/16-512 + DoRA + FILIP - held-out excluded (single GPU)")
