...
```bash
python train/encoders/anchor_tcap_heldout/train.py --gpu 0 --run-note anchor_tcap_heldout
```
...
Outputs land in `assets/runs/anchor_tcap_heldout/`.

## Next step

```bash
python train/encoders/anchor_tcap_heldout/search_swa_range.py assets/runs/anchor_tcap_heldout --gpu 0
```

The printed range goes to [`anchor_tcap_all/build_swa.py`](../anchor_tcap_all/build_swa.py).
